...
public class RedSearchAutonA extends SequentialCommandGroup {
  ...
  public RedSearchAutonA(Drivetrain m_drive, Intake m_intake) {
    ...
    addCommands(new DriveAndIntake(m_drive, m_intake, 5 * drivePID.feetToRotations));// , new RotateInPlace(m_drive,
                                                                                     // 26.56),
    // new DriveAndIntake(m_drive, m_intake, 5.6 * drivePID.feetToRotations), new
