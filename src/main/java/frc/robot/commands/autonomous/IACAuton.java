...
public class IACAuton extends SequentialCommandGroup {
  ...
  public IACAuton(Drivetrain m_drive, Turret m_turret, Index m_index, ShootingSystem m_shooter, Hood m_hood,
    ...
    addCommands(new CloseRangeShootingMacro(m_drive, m_turret, m_index, m_shooter, m_hood, 3, shooterSpeed, 2000),
        ...
        new ShootingMacro(m_drive, m_turret, m_shooter, m_index, m_hood, 3, 0, 2000, false, 2),
