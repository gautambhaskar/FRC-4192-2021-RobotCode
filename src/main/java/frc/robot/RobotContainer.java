...
public class RobotContainer {
  ...
  private final UILAuton uilAuton1 = new UILAuton(m_drive, m_turret, m_shootingSystem, m_index, m_hood, 1);
  private final UILAuton uilAuton2 = new UILAuton(m_drive, m_turret, m_shootingSystem, m_index, m_hood, 2);
  private final UILAuton uilAuton3 = new UILAuton(m_drive, m_turret, m_shootingSystem, m_index, m_hood, 3);
